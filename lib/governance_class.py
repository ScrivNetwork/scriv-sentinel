...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to scrivd "gobject list" output
    ...
    def scrivd_serialise(self):
        import scrivlib
        return scrivlib.SHIM_serialise_for_scrivd(self.serialise())
